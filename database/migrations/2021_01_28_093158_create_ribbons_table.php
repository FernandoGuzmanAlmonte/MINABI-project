...
class CreateRibbonsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('ribbons', function (Blueprint $table) {
            ...
            $table->float('pesoCinta', 12, 4)->nullable(); //peso de la cinta blanca
            $table->float('pesoCelofan', 12, 4)->nullable();
            $table->float('costoCelofan', 12, 4)->nullable();
            $table->float('costoCinta', 12, 4)->nullable();
